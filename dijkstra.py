...
def main():
    ...
    while True:
        for event in pygame.event.get():
            ...
            start_input = start_box.handle_event(event)
            end_input = end_box.handle_event(event)

            if start_input and start_input in nodes:
                start = start_input
            if end_input and end_input in nodes:
                end = end_input
